"""
Django settings for falling_leaf_dev_60463 project.
...
ROOT_URLCONF = 'falling_leaf_dev_60463.urls'
...
WSGI_APPLICATION = 'falling_leaf_dev_60463.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_leaf_dev_60463 API",
    "DESCRIPTION": "API documentation for falling_leaf_dev_60463 App",
    "VERSION": "v1",
}
